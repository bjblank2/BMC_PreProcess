...
do_this = "COMP_VASP"
root_dir = "D:/test_cluster/test_cluster"
vasp_data_file = './test'
...
spin_tol = [.005, 2, 0]  # .05                          # insert spin parameters here, this assumes [Ni Mn In ]
species = ['Pb', 'S', 'Se']  # this is the order that the post-processed data is reported, NEEDS TO BE Heusler format Ni2MnIn, Ni2FeGa.


if do_this == "COMP_VASP":
    cvd.import_vasp1(root_dir, vasp_data_file, species)
    print('\n')
    #M_structures = ppv.generate_m_structure(vasp_data_file, aust_tol, spin_style, spin_tol)
    #print('\n')
